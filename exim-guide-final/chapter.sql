...
--
-- Host: localhost
-- Generation Time: Jan 11, 2014 at 03:59 PM
...
CREATE TABLE IF NOT EXISTS `chapter` (
  ...
  `chapter_des` varchar(250) DEFAULT NULL,
...
INSERT INTO `chapter` (`chapter_no`, `chapter_des`) VALUES
(1, 'Live Animals'),
...
(34, 'Soap,Organic Surface-Active Agents,Washing Preparations,LubricatingPreparations, Artificial Waxes,Prepared WaxesPolishing or Scouring Preparations, Candles and similar Articles, modelling Pastes, Dental Waxes and Dental Preparations with Basis of Pla'),
